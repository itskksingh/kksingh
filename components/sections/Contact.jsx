...
const ContactSection = () => {
  return (
    <section className='max-w-7xl mx-auto px-4 pt-15 pb-5 flex flex-col text-white overflow-hidden'>
      {/* Heading */}
      ...
      <div className='grid md:grid-cols-3 gap-10'>
        ...
        {/* Contact Info */}
        <div className='flex flex-col gap-8 justify-start text-xl font-mono  text-zinc-300'>
          <ContactItem
