...
const Header = () => {
  return (
    <header className=' max-w-lg md:max-w-5xl lg:max-w-7xl mx-auto px-2 md:px-4 lg:px-8'>
      <div className='w-full px-4 py-3 lg:py-4 border border-zinc-600 bg-[#272730] rounded-lg  mx-auto flex items-center justify-between flex-wrap gap-4'>
        {/* Logo + Brand */}
        <div className='flex items-center gap-3'>
          ...
          <span className='text-lg lg:text-2xl font-mono font-semibold logo-name'>kksingh.dev</span>
        </div>
